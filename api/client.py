...
def browser_instance():
    ...
    # Priority: CI env → HEADLESS env var → config → default True
    ...
    if is_ci:
        ...
        headless = env_headless.lower() == "true"   # ← respect env var locally
    else:
        headless = config_headless                  # ← fall back to config
